...
/*
            service.post("/nexusrest", (req, res, next) => {
                console.log("POST nexusrest");
                next();
            });
            service.get('/nexusrest', function (err, res, next) {
                console.log("GET nexusrest");
                next();
            });
*/
